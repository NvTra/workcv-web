...
<!-- <link href="/PRJ321x_Project1_tinhFX16776/css/styles.css" rel="stylesheet" /> -->
<link
	href="/PRJ321x_Project1_tinhFX16776/resources/static/admin1/assets/css/styles.css"
	rel="stylesheet" />
<script
...
<script
	src="/PRJ321x_Project1_tinhFX16776/resources/static/admin1/assets/js/scripts.js"></script>
<script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest"
	crossorigin="anonymous"></script>

<!-- <script src="../../static/admin1/assets/js/datatables-simple-demo.js"></script> -->
<script
	src="/PRJ321x_Project1_tinhFX16776/resources/static/admin1/assets/js/datatables-simple-demo.js"></script>
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										...
										<div class="modal-body">
											<form:form action="themMoiNguoiDung" modelAttribute="user"
												method="post">
											...
											<tr>
												...
												<td>
													...
													<button type="button" style="width: 80px"
														...
														Chi tiết</button>
													<button href="${deleteUserLink}" onclick="if (!(confirm('Bạn chắc chắn muốn xóa?')))" type="button" style="width: 80px"
														class="btn btn-danger mt-1" data-bs-toggle="modal"
														data-bs-target="#deleteUser+${tempUser.id}">Xóa</button>
														
														<%-- th:data-bs-target="'#idModelDel'+${user.id}">Xóa</button> --%>						
                                                        
													<c:url var="deleteUserLink" value="/deleteUser">
														<c:param name="useId" value="${tempUser.id}"></c:param> 
													</c:url>
													<!--  --> <c:choose>
														<c:when test="${tempUser.status==1}">
															<!-- <form action="@{/ql-user/lock}" method="post" -->
															<form action="ql-user/lock" method="post"
																<%-- style="margin-left: 85px; margin-top: -38px" --%>
																>
																<input type="hidden" class="form-control" id="id"
																	name="idUser" value="${tempUser.id}">
																<button type="submit" style="width: 80px"
																	class="btn btn-danger">Khóa</button>
															</form>
														</c:when>
														<c:when test="${tempUser.status==0}">
															<!-- <form th:action="@{/ql-user/un-lock}" method="post"> -->
															
															<form action="ql-user/un-lock" method="post">
																<input type="hidden" class="form-control" id="id"
																	name="idUser" value="${tempUser.id}">
																<button type="submit" style="width: 80px"
